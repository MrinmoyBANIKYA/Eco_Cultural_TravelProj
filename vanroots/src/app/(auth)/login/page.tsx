    ...
    <div className="flex min-h-screen items-center justify-center bg-[#fafafa] px-6">
      <div className="w-full max-w-md space-y-8 rounded-[2rem] bg-white p-10 shadow-2xl">
        <div className="text-center">
          <h2 className="text-3xl font-bold tracking-tight text-[#0f4a45]">Welcome Back</h2>
          <p className="mt-2 text-sm text-gray-500">Sign in to your VanRoots account</p>
        </div>
        <form className="mt-8 space-y-6">
          ...
          <div className="text-center text-sm">
            ...
            <Link href="/register" className="font-bold text-[#f6931e] hover:underline">
              Create one
            </Link>
          </div>
        </form>
